          ...
          children: [
            Center(
              child: SizedBox(
                ...
                width: screenWidth * 0.8,
                child: Image.asset(
                  'assets/4se.jpg', // Placeholder image for Infrared Remote Receiver
                  fit: BoxFit.contain,
                  errorBuilder: (context, error, stackTrace) {
                    return Column(
                      mainAxisAlignment: MainAxisAlignment.center,
            ...
            Center(
              child: SizedBox(
                ...
                width: screenWidth * 0.8,
                child: Image.asset(
                  '5se.jpg', // Pin diagram image for Infrared Remote Receiver
                  fit: BoxFit.contain,
                  errorBuilder: (context, error, stackTrace) {
                    return Column(
                      mainAxisAlignment: MainAxisAlignment.center,
            ...
            Center(
              child: SizedBox(
                ...
                width: screenWidth * 0.7,
                child: Image.asset(
                  'assets/6se.jpg', // Replace with another pin diagram image
                  fit: BoxFit.contain,
                  errorBuilder: (context, error, stackTrace) {
                    return Column(
                      mainAxisAlignment: MainAxisAlignment.center,
