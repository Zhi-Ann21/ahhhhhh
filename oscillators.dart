          ...
          children: [
            Center(
              child: SizedBox(
                ...
                width: screenWidth * 0.8,
                child: Image.asset(
                  'assets/7o.jpg', // Replace with your LED image
                  fit: BoxFit.contain,
                  errorBuilder: (context, error, stackTrace) {
                    return Column(
                      mainAxisAlignment: MainAxisAlignment.center,
            ...
            Center(
              child: SizedBox(
                ...
                width: screenWidth * 0.8,
                child: Image.asset(
                  'assets/8o.jpg', // Replace with your LED pin diagram image
                  fit: BoxFit.contain,
                  errorBuilder: (context, error, stackTrace) {
                    return Column(
                      mainAxisAlignment: MainAxisAlignment.center,
            ...
            Center(
              child: SizedBox(
                ...
                width: screenWidth * 0.7,
                child: Image.asset(
                  'assets/9o.jpg', // Replace with another pin diagram image
                  fit: BoxFit.contain,
                  errorBuilder: (context, error, stackTrace) {
                    return Column(
                      mainAxisAlignment: MainAxisAlignment.center,
          ...
          children: [
            ...
            Center(
              child: SizedBox(
                ...
                width: screenWidth * 0.8,
                child: Image.asset(
                  'assets/10o.jpg', // Replace with your asset image path
                  fit: BoxFit.contain,
                  errorBuilder: (context, error, stackTrace) {
                    return Column(
                      mainAxisAlignment: MainAxisAlignment.center,
            ...
            Center(
              child: SizedBox(
                ...
                width: screenWidth * 0.8,
                child: Image.asset(
                  'assets/11o.jpg', // Replace with your asset image path
                  fit: BoxFit.contain,
                  errorBuilder: (context, error, stackTrace) {
                    return Column(
                      mainAxisAlignment: MainAxisAlignment.center,
            ...
            Center(
              child: SizedBox(
                ...
                width: screenWidth * 0.7,
                child: Image.asset(
                  'assets/12o.jpg', // Replace with your asset image path
                  fit: BoxFit.contain,
                  errorBuilder: (context, error, stackTrace) {
                    return Column(
                      mainAxisAlignment: MainAxisAlignment.center,
          ...
          children: [
            ...
            Center(
              child: SizedBox(
                ...
                width: screenWidth * 0.8,
                child: Image.asset(
                  'assets/13o.jpg', // Replace with your phototransistor image
                  fit: BoxFit.contain,
                  errorBuilder: (context, error, stackTrace) {
                    return Column(
                      mainAxisAlignment: MainAxisAlignment.center,
            ...
            Center(
              child: SizedBox(
                ...
                width: screenWidth * 0.8,
                child: Image.asset(
                  'assets/14o.jpg', // Replace with first pin diagram image path
                  fit: BoxFit.contain,
                  errorBuilder: (context, error, stackTrace) {
                    return Column(
                      mainAxisAlignment: MainAxisAlignment.center,
            ...
            Center(
              child: SizedBox(
                ...
                width: screenWidth * 0.7,
                child: Image.asset(
                  'assets/15o.jpg', // Replace with second pin diagram image path
                  fit: BoxFit.contain,
                  errorBuilder: (context, error, stackTrace) {
                    return Column(
                      mainAxisAlignment: MainAxisAlignment.center,
